About elyra-python-editor-extension
===================================
...
Once the `conda-forge` channel has been enabled, `elyra-python-editor-extension` can be installed with:

```
conda install elyra-python-editor-extension
```

It is possible to list all of the versions of `elyra-python-editor-extension` available on your platform with:
